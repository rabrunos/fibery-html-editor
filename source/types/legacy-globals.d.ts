...
declare global {
  ...
  function iconMoreVertical(options?: { className?: string }): string;
  function iconChevronLeft(options?: { className?: string }): string;
  function iconChevronRight(options?: { className?: string }): string;
  function iconChevronDown(options?: { className?: string }): string;
  function iconCode(options?: { className?: string }): string;
  function iconSettings(options?: { className?: string }): string;
